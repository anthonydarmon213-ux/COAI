...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    reponse:
      "Le bilan initial est gratuit. COAI Essentiel coûte ensuite 19,99€/mois (ou 119€/an) avec 7 jours d'essai, sans engagement. Pour le regard d'un coach diplômé d'État, Premium Remote est un accompagnement individuel avec Anthony, sur devis (engagement minimum 3 mois, payé en une fois).",
  },
];

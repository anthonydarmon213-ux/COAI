...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    reponse:
      "Sur Impulsion (9€, paiement unique), ton programme est construit par les algorithmes COAI sans relecture. Sur Transformation (49€/mois), chaque programme est en plus relu et validé par un coach diplômé d'État.",
  },
  {

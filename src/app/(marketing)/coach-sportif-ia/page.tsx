...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    reponse:
      "COAI Essentiel coûte 19,99€/mois (ou 119€/an) avec 7 jours d'essai et un coach IA disponible 24h/24, sans engagement. Premium Remote ajoute le regard d'un coach humain, dans le cadre d'un accompagnement sur devis (engagement minimum 3 mois).",
  },
];

...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    reponse:
      "Non — l'inscription est gratuite, sans carte bancaire. Tu débloques ensuite Impulsion dès 9€ ou Transformation (49€/mois, 7 jours offerts, avec relecture par un coach diplômé d'État) quand tu es prêt.",
  },
];

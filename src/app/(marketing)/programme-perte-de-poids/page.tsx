...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    reponse:
      "Non — l'inscription est gratuite, sans carte bancaire. Tu débloques ensuite Impulsion (19€, paiement unique) ou Transformation (49€/mois, 7 jours offerts, avec relecture par un coach diplômé d'État) quand tu es prêt.",
  },
];

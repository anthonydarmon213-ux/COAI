...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    reponse:
      "Non — le diagnostic est offert. Tu choisis ensuite COAI Essentiel (19,99€/mois ou 119€/an, 7 jours d'essai) ou un accompagnement avec Anthony — Premium Remote ou VIP Présentiel, sur devis (engagement minimum 3 mois).",
  },
];

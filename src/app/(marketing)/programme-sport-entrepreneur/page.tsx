...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    reponse:
      "Standard IA coûte 19,99€/mois (ou 119€/an) avec 7 jours d'essai et un coach IA disponible 24h/24, sans engagement. Premium Remote ajoute le regard d'un coach humain diplômé d'État, dans le cadre d'un accompagnement sur devis (engagement minimum 3 mois).",
  },
];

...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    reponse:
      "Impulsion coûte 49€/mois avec 7 jours d'essai et un coach IA disponible 24h/24. Transformation coûte 89€/mois avec 7 jours d'essai et ajoute le regard d'un coach diplômé d'État. Les deux sont sans engagement.",
  },
];

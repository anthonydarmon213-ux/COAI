...
export async function GET() {
  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: 86, backgroundColor: "#090a0b", backgroundImage: "radial-gradient(circle at 18% 12%, rgba(201,162,98,0.26), transparent 48%), radial-gradient(circle at 90% 88%, rgba(58,90,107,0.2), transparent 52%)", fontFamily: "system-ui, sans-serif", color: "#f5f6f7" }}>

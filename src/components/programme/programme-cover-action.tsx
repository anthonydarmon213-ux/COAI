...
export function ProgrammeCoverAction({
  ...
  return (
    <button
      ...
      aria-label={label}
      className="group/cover relative block h-48 w-full cursor-pointer overflow-hidden bg-[radial-gradient(circle_at_30%_20%,rgba(196,154,82,.25),transparent_60%),#171b1d] text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-laiton-300 sm:h-52"
    >
      {children}

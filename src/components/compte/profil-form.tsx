      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3 rounded-lg border border-laiton-400/25 bg-laiton-400/[0.04] p-4">
          ...
          <label className="w-fit">
            ...
            />
            <span className="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-laiton-400/40 bg-laiton-400/10 px-4 py-2 text-sm font-bold text-laiton-200 transition hover:bg-laiton-400/[0.18]">
              {montreLoading ? "Analyse en cours…" : "Analyser un screenshot"}
            </span>
          </label>
          <p className="text-xs font-medium text-graphite-400">Jusqu’à 40 Mo · image 4K optimisée automatiquement avant analyse.</p>
        ...
        <div className="flex flex-col gap-3 rounded-lg border border-laiton-400/25 bg-laiton-400/[0.04] p-4">
          ...
          <p className="text-xs font-medium text-graphite-400">Jusqu’à 40 Mo · photo 4K optimisée automatiquement avant analyse.</p>

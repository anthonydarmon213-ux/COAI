      ...
      <div className="pointer-events-none relative z-10 flex h-full w-full flex-col justify-between p-5 sm:p-8">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            type="button"
            onClick={dismiss}
            className="pointer-events-auto rounded-full border border-white/35 bg-black/35 px-5 py-2.5 text-sm font-semibold text-white backdrop-blur-md transition hover:bg-white hover:text-graphite-950 focus:outline-none focus:ring-2 focus:ring-white"
          >
            Passer
          </button>
        </div>

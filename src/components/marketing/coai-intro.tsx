...
export function CoaiIntro() {
  return (
    <section className="coai-future-hero coai-landing-hero relative flex min-h-[calc(100svh-5rem)] flex-col items-center justify-center gap-6 overflow-hidden px-6 pb-10 pt-24 text-center sm:pb-12 sm:pt-28">
      ...
      <div className="relative z-10 flex items-center gap-3" aria-label="COAI">
        <CoaiMark size={54} variant="detailed" animated />
        <span className="font-display text-2xl font-semibold tracking-[0.22em] text-[#171817] sm:text-3xl">
          COAI
        </span>
      </div>

      <div className="coai-landing-promise relative z-10 flex w-full max-w-3xl flex-col items-center gap-4 rounded-[2rem] border px-5 py-7 backdrop-blur-md sm:px-10 sm:py-8">
      ...
      <div className="relative z-10 -mt-4 flex flex-col items-center gap-4">
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Link href="/diagnostic" className="relative">
            ...
            >
              <span>Évaluer mon niveau en 2 min</span>
            </Button>
          </Link>

...
// premiers abonnés et retours terrain) : le tarif Pass IA est conservé
// tant que l'abonnement reste actif pour les 100 premiers abonnés. Pass IA est facturé 19,99€/mois (ou

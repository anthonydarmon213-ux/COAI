...
export const EXERCICES: Exercice[] = [
  ...
  { id: "squat-poids-du-corps", nom: "Air squat (poids du corps)", groupePrincipal: "JAMBES", materiel: ["POIDS_DU_CORPS"], type: "FORCE", niveau: "DEBUTANT", consigne: "Descends comme pour t'asseoir sur une chaise, poids réparti sur tout le pied, genoux dans l'axe, sans charge dans les mains.", photoQuery: "bodyweight squat exercise athlete", freeExerciseDbId: "Bodyweight_Squat" },
  ...
  { id: "releve-jambes-suspendu", nom: "Relevé de genoux suspendu", groupePrincipal: "ABDOMINAUX", materiel: ["BARRE"], type: "FORCE", niveau: "INTERMEDIAIRE", consigne: "Suspendu à une barre, remonte les genoux vers la poitrine en contrôlant, sans te balancer ni tirer avec les épaules.", photoQuery: "hanging knee raise exercise" },

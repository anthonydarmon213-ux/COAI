...
export const EXERCICES: Exercice[] = [
  ...
  { id: "leg-curl-machine", nom: "Leg curl (machine)", groupePrincipal: "JAMBES", materiel: ["MACHINE"], type: "FORCE", niveau: "DEBUTANT", consigne: "Fléchis les jambes vers l'arrière en contrôlant la remontée, sans à-coup.", photoQuery: "lying leg curl machine gym" },
